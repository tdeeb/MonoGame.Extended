...
namespace MonoGame.Extended
{
    ...
    public static class ShapeExtensions
    {
            ...
            Color color, float thickness)
        {
            ...
            spriteBatch.Draw(texture, point1, sourceRectangle: null, color: color, rotation: angle, origin: Vector2.Zero, scale: scale, effects: SpriteEffects.None, layerDepth: 0f);
        }
            ...
            float thickness = 1f)
        {
            ...
            spriteBatch.Draw(texture, topLeft, sourceRectangle: null, rotation: 0f, origin: Vector2.Zero, scale: horizontalScale, color: color, effects: SpriteEffects.None, layerDepth: 0f);
            spriteBatch.Draw(texture, topLeft, sourceRectangle: null, rotation: 0f, origin: Vector2.Zero, scale: verticalScale, color: color, effects: SpriteEffects.None, layerDepth: 0f);
            spriteBatch.Draw(texture, topRight, sourceRectangle: null, rotation: 0f, origin: Vector2.Zero, scale: verticalScale, color: color, effects: SpriteEffects.None, layerDepth: 0f);
            spriteBatch.Draw(texture, bottomLeft, sourceRectangle: null, rotation: 0f, origin: Vector2.Zero, scale: horizontalScale, color: color, effects: SpriteEffects.None, layerDepth: 0f);
        }
        ...
        public static void DrawPoint(this SpriteBatch spriteBatch, Vector2 position, Color color, float size = 1f)
        {
            ...
            spriteBatch.Draw(GetTexture(spriteBatch), position + offset, sourceRectangle: null, rotation: 0f, origin: Vector2.Zero, color: color, scale: scale, effects: SpriteEffects.None, layerDepth: 0f);
        }
